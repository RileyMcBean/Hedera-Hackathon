...
import { getAudit, submitIntent } from './api';
...
import type { Actor, AuditRecord, IntentResponse, Policy, PipelineStages } from './types';
...
const POLICIES: Policy[] = [
  ...
  { id: 'AMOUNT_THRESHOLD',         description: 'Transfer amount must not exceed the actor\'s per-transaction HBAR limit.', threshold: undefined },
];
...
export default function App() {
  ...
  const handleSubmit = useCallback(async (text: string, actorId: string) => {
    ...
    // Animate intent stage and fire API simultaneously
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      <Header onReset={handleReset} resetting={false} />
